...
import AC from '../../assets/icons/flags/AC.svg';
...
import BQ from '../../assets/icons/flags/BQ.svg';
...
import TA from '../../assets/icons/flags/TA.svg';
...
export function Flag({ country }: { country: string }): React.JSX.Element {
  const Icon = map[country as keyof typeof map];
  if (!Icon) return <Fallback />;
  return <Icon width={30} height={20} />;
}
