    ...
    return (organizedWallets &&
      ...
      <div style={{ color: textColor }} className="pw-py-[6px] pw-px-2 pw-shadow-[2px_2px_10px_rgba(0,0,0,0.08)]">
        ...
        <div className="pw-flex pw-items-center">
          <CriptoValueComponent textColor={textColor} pointsPrecision={organizedWallets[0].pointsPrecision} fontClass='pw-text-sm' crypto={true} value={organizedWallets[0].balance} code={chainIdToCode(
    ...
    <div className="pw-relative">
      ...
      >
        ...
        <div className="pw-mt-[10px]">
          ...
          {organizedWallets.length && organizedWallets.some((w) => w.type == 'loyalty') && !hideLoyaltyAuthentication ?
            <WeblockButton
