        ...
        tenantInputs?.map((item) => (
          ...
          >
            <SmartInputsController
              ...
              inputImageTitle={(item?.data as any)?.title}
              inputImageSubtitle={(item?.data as any)?.subtitle}
              inputImagePlaceholder={(item?.data as any)?.placeholderImage}
              inputImageInstructions={(item?.data as any)?.instructions}
              ...
              acceptImageTypes={(item?.data as any)?.acceptTypes}
            />
          </div>
        ))}
      {children}
