    ...
    <div className="pw-mb-3">
      ...
      <FormItemContainer invalid={fieldState.invalid}>
        <input
          ...
          value={inputValue}
          className="pw-mt-1 pw-text-base pw-h-[48px] pw-text-[#969696] pw-leading-4 pw-w-full !pw-rounded-lg pw-bg-transparent pw-px-[10px] autofill:pw-bg-transparent focus:pw-outline-none sm:pw-text-base"
        />
      </FormItemContainer>
      <p className="mt-5">
        {field.value && (
