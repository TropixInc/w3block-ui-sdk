...
import CashIcon from '../../shared/assets/icons/cashFilled.svg';
import EyeIcon from '../../shared/assets/icons/eyeIcon.svg';
import EyeCrossedIcon from '../../shared/assets/icons/eyeIconCrossed.svg';
import MetamaskIcon from '../../shared/assets/icons/metamask.svg';
import WalletIcon from '../../shared/assets/icons/walletOutlined.svg';
        ...
        <div className="pw-w-full pw-items-center pw-justify-between pw-hidden sm:pw-flex">
          ...
          <div className="pw-flex pw-items-center pw-gap-4">
            ...
            {isLoading ? (
              ...
              profile?.data.wallets?.map((wallet: { type: WalletTypes; id: Key | null | undefined; }) => {
