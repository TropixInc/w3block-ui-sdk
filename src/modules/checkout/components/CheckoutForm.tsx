...
import { PRODUCT_VARIANTS_INFO_KEY, PRACTITIONER_DATA_INFO_KEY } from '../config/keys/localStorageKey';
import { useCart } from '../hooks/useCart';
import { useCheckout } from '../hooks/useCheckout';
import { ProductErrorInterface, PaymentMethodsAvaiable, OrderPreviewResponse } from '../interface/interface';
